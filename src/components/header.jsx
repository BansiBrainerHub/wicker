    ...
    <>
      <Headerwrapper>
        <>
          ...
          <DBindingwrapper onClick={onOpenModal}>
            <Bindingcontent>
          ...
          <Contactmodalwrapper>
            <Modal open={open} onClose={onCloseModal} center>
              <Customemodal>
                ...
                <Customemodalrow >
                  <Customemodalgroup1>
                    <input type='text' className='form-control' placeholder='Ihre Mailadresse'></input>
                  </Customemodalgroup1>    
                </Customemodalrow>
                <Customemodalrow>
                  <Customemodalgroup1>
                    <textarea  className='text_control'  rows="5" cols="50" placeholder='Nachricht Hier können Sie uns zusätzliche Anliegen schildern oder Fragen stellen.' ></textarea>
                  </Customemodalgroup1>  
                </Customemodalrow>
                <Customemodalrow>
                  <Customemodalgroup1>
                    <div className='modalcheckbox'>
                      <Checkbox>
                        ...
                        Ich stimme einer Kontaltaufnahme durch Wicker & Partner zu und bin damit einverstanden, dass meine Daten nur für diesen Zweck weltergeleltet werden.
                          <input type="checkbox" />
                ...
                <Customemodalrow>
                    <Customemodalgroup1>
                      <div className='modalcheckbox'>
                        <Checkbox>
                          <label class="checkBox">
                          Ich habe die AGB und Datensechutzbestimmungen gelesen und akzeptlert.
                            <input type="checkbox" />
                            <span class="checkmark"></span>
                          </label>
                        </Checkbox>
